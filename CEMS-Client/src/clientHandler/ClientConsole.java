...
public class ClientConsole implements ChatIF {
	...
	public void accept() {
		try {
			...
			// SELECT * FROM lab6schema.students;
			// newList.add("SELECT ID, userName FROM lab6schema.students WHERE (`ID` =
			// '123456');");
			// newList.add("SELECT ID FROM lab6schema.students WHERE (`ID` = '123457');");
			// newList.add("INSERT INTO `projecton`.`questions` (`id`, `subject`, `course
			// name`, `question text`, `question number`, `lecturer`) VALUES ('00', 'Math',
			// 'Calculus 1', 'how are you ?', '1', 'Misha');");
			// client.handleMessageFromClientUI(newList.get(0));
			// client.handleMessageFromClientUI(newList.get(1));
			// client.handleMessageFromClientUI(newList.get(2));
		} catch (Exception ex) {
