...
public class StudentScreenController extends BasicController {
    ...
    // The TextArea that displays help information
    @FXML
    ...
    // This method is called when the StudentScreen view is loaded. It initializes the student field and starts the clock.
    ...
    // This method is called when the Log Out button is pressed. It logs the student out and closes the StudentScreen view.
    @FXML
    void LogOutPressed(ActionEvent event) {
        logoutPressed(event);
    }

    // This method is called when the Open Code Prompt button is pressed. It opens the EnterCodeForTestPreforming view.
    @FXML
    ...
    // This method is called when the Show Grades button is pressed. It opens the ViewGrades view.
    @FXML
