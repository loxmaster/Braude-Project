...
public class HODPermissionController extends BasicController {
    ...
    public void load() {
        ...
        // buttons
        Approve.setCellValueFactory(
                cellData -> new SimpleObjectProperty<Button>(createButtons(cellData.getValue(), "Approve")));
        Deny.setCellValueFactory(
                cellData -> new SimpleObjectProperty<Button>(createButtons(cellData.getValue(), "Deny")));
