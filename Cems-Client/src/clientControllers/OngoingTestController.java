...
public class OngoingTestController extends BasicController {
	...
	public static void setSubjectsCoursesList(ArrayList<String> SubjectandCourses) {
        SubjectCourses = SubjectandCourses;
    }
    ...
    private Button createUnlockTestButton(Test test, String btnName, Button UnlockBTN, Button addtimeBTN, Button lockBTN) {
    ...
    public Button createLockTestButton(Test test, String btnName, Button locked, Button addtimeBTN, Button UnlockBTN) {
	   ...
	   @FXML
	    void AddTimePressed(ActionEvent event) throws IOException {
		   ...
		   TestTimeAddController cqc = (TestTimeAddController) openScreen("/clientFXMLS/LecturerTimeExtensionRequest.fxml", "CEMS System - Lecturer - Test time Extension Request", event);
